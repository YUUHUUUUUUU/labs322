...
public class App{
    ...
    public static void main(String[] args){
        ...
        Effect energybuff = new PoisonEffect("Energy Buff", "Increase of energy in the beginning of the next 3 rounds", 3, 3);
        Effect poison = new EnergyEffect("Poison", "Reduces life in the end of the next 2 rounds", 2, 4);
        ...
        hero.getDeck().getShop().add(poison); //criar carta!!!
        hero.getDeck().getShop().add(energybuff);//criar carta
        ...
        String placeholder = nome.nextLine();
